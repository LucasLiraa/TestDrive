...
namespace Backend.Business
{
    public class ClienteBusiness
    {
        ...
        public Models.TbCliente Cadastrar(Models.TbCliente client)
        {
            ...
            if(client.NrCelular.ToString().Length != 11) throw new ArgumentException("Número inválido");
        ...
        public Models.TbLogin CadastrarLogin(string email, string senha)
        {
            ...
            if(senhaForte(senha) && senha.Length >= 8) throw new ArgumentException("Senha fraca. Tente melhora-la");
