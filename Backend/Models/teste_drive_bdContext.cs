...
{
    public partial class teste_drive_bdContext : DbContext
    {
        public teste_drive_bdContext()
        {
        }

        public teste_drive_bdContext(DbContextOptions<teste_drive_bdContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;user id=root;password=12345;database=teste_drive_bd", x => x.ServerVersion("8.0.21-mysql"));
            }
        }
